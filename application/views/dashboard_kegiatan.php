...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>aset/css/dashboard-kegiatan.css">
		...
		<table class="table">
			...
			<?php foreach ($view as $data) : ?>
				<tr>
					...
					<td data-label="Jam Pulang"><?php echo $data->lokasi ?></td>
					...
					<td data-label="Kegiatan"><?php echo $data->status ?></td>
					<td class="action-wrap">
						<a href="<?php echo base_url('MainController/form_edit_kegiatan') ?>/<?php echo $data->id ?>" class="edit-btn">edit</a>
					</td>
				</tr>
			<?php endforeach;  ?>
		</table>
